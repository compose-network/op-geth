...
func (x *StartSC) Reset() {
	*x = StartSC{}
	mi := &file_rollup_messages_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*StartSC) Descriptor() ([]byte, []int) {
	return file_rollup_messages_proto_rawDescGZIP(), []int{16}
}
...
func (x *Message) Reset() {
	*x = Message{}
	mi := &file_rollup_messages_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Message) Descriptor() ([]byte, []int) {
	return file_rollup_messages_proto_rawDescGZIP(), []int{17}
}
...
var file_rollup_messages_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
...
func file_rollup_messages_proto_init() {
	...
	file_rollup_messages_proto_msgTypes[17].OneofWrappers = []any{
